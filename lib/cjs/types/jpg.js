...
function isEXIF(buffer, offset) {
    return toHexadecimal_js_1.default(buffer, offset + 2, offset + 6) === EXIF_MARKER;
}
...
exports.JPG = {
    validate(buffer) {
        const SOIMarker = toHexadecimal_js_1.default(buffer, 0, 2);
    ...
    calculate(buffer) {
        ...
        while (buffer.byteLength) {
            ...
            const i = readUInt_js_1.readUInt16BE(buffer, offset);
